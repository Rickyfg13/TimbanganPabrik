                      ...
                      @foreach ($list as $item)
                          <tr>
                            <td>{{ $loop->iteration }}</td>
                              ...
                              <td>{{$item->total_timbang_lapangan}}</td>
                              <td>{{date('d F Y H:i:s',strtotime($item->created_at))}}</td>
                              <td>
                                <a href="timbanglapangan/{{ $item->id }}/edit" class="btn btn-primary "><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
                                ...
                                <div class="modal-dialog">
                                  <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                      ...
                                      <form action="timbanglapangan/{{ $item->id }}" method="POST">
                                        @csrf
                                        @method("delete")
                                        Apakah Anda Yakin?
                                    </div>
