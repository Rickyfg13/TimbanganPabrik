            ...
            <div class="card-header">
              ...
              <div class="card-body">
                <div class="modal-body">
                    <div class="container">
                        <div class="row">
                         <form action="{{ route('timbangpabrik.store') }}" method="POST">
                                @csrf
                            ...
                            <div class="mb-3">
                                    ...
                                    <input type="number" id="total_timbang_pabrik" onkeyup="tambah();" class="form-control" name="total_timbang_pabrik" readonly>
                            </div>
                                <div class="modal-footer">
                                <a href="{{route ('timbangpabrik.index') }}" class="btn btn-danger">Kembali</a>
